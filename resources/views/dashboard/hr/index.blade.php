            ...
            <div class="page-container">
                ...
                <section class="summary-cards">
                    <div class="card summary-card">
                        ...
                        <p class="summary-card__value" id="valTotal">0</p>
                    ...
                    <div class="card summary-card">
                        ...
                        <p class="summary-card__value" id="valFullTime">0</p>
                        <div class="summary-card__footer">
                            <span class="trend-badge text-success">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline>
                    ...
                    <div class="card summary-card">
                        ...
                        <p class="summary-card__value" id="valPartTime">0</p>
                        <div class="summary-card__footer">
                    ...
                    <div class="card summary-card">
                        ...
                        <p class="summary-card__value" id="valOnLeave">0</p>
                        <div class="summary-card__footer">
                            <div class="progress-bar">
                ...
                <section class="card table-section">
                    <div class="table-toolbar">
                        <div class="table-filters">
                            <span class="filter-label">All Status <span class="filter-count"
                            ...
                            <div class="search-wrapper">
                                <input type="text" class="form-input" id="searchName" placeholder="Search name...">
                            </div>
                        </div>
                        ...
                        <table class="data-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Nama</th>
                                    <th>Posisi</th>
                                    <th>Departemen <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" class="icon-sort">
                                            <polyline points="6 9 12 15 18 9"></polyline>
                                        </svg></th>
                                    <th>Status</th>
